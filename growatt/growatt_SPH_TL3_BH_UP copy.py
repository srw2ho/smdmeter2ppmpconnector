...
class SPH_TL3_BH_UP(Growatt):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.registers = {
            ...
            "PV1Curr": (2, 2, meter.registerType.INPUT, meter.registerDataType.UINT16, float, "PV1 input current", "A", 1, 0.1),
            ...
            "Pac": (35, 4, meter.registerType.INPUT, meter.registerDataType.UINT32, float, "Output power", "W", 2, 0.1),
