...
class SPH_TL3_BH_UP(Growatt):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.registers = {
            ...
            "LocalLoad_total": (1037, 4, meter.registerType.INPUT, meter.registerDataType.UINT32, float, "INV_power to local load total", "W", 6, 0.1),
            "Etouser_today": (1044, 4, meter.registerType.INPUT, meter.registerDataType.UINT32, float, "Energy_to user today", "W", 6, 0.1),
            "Etouser_total": (1046, 4, meter.registerType.INPUT, meter.registerDataType.UINT32, float, "Energy_to user total", "W", 6, 0.1),
            "Etogrid_today": (1048, 4, meter.registerType.INPUT, meter.registerDataType.UINT32, float, "Energy_to grid today", "W", 6, 0.1),
            ...
            "BMS_BatteryVolt": (1087, 2, meter.registerType.INPUT, meter.registerDataType.UINT16, float, "Battery voltage from BMS", "V", 7, 1),
            "BMS_BatteryCurrent": (1088, 2, meter.registerType.INPUT, meter.registerDataType.UINT16, float, "Battery current from BMS", "A", 7, 1),
            "BMS_BatteryTemp": (1089, 2, meter.registerType.INPUT, meter.registerDataType.UINT16, float, "Battery temperature from BMS", "°C", 7, 1),
            ...
            "Power_factor": (5, 2, meter.registerType.HOLDING, meter.registerDataType.UINT16, int, "Inverter output power factor’s 10000 times", "%", 1, 1000),
